...
namespace EjercicioBlackJackConNombresyArreglosDiapo13
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Primeros 3 lugares, puntajes y nombres

            Console.WriteLine("Los mejores puntajes son: ");
            int longitud = Math.Min(n, puntajes.Length);
            for (int i = 0; i < puntajes.Length - 1; i++)
            {
                Console.WriteLine("Puntaje: " + puntajes[i]);
